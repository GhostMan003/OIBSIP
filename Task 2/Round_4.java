...
public class Round_4 extends JFrame implements ActionListener {
    ...
    public Round_4(String scoreString) {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (numberString.equals("")) {
                ...
                new Round_5(scoreString).setVisible(true);
            }
