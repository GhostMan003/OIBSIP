...
public class Round_2 extends JFrame implements ActionListener {
    ...
    public Round_2(String scoreString) {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (numberString.equals("")) {
                ...
                new Round_3(scoreString).setVisible(true);
            }
